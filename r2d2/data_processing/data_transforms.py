...
class ImageTransformer:
	...
	def __init__(self, remove_alpha=False, bgr_to_rgb=False, augment=False, to_tensor=False, image_path='observation/camera/image'):
		...
		if bgr_to_rgb:
			def helper(data):
				if data.shape[-1] == 4: return cv2.cvtColor(data, cv2.COLOR_BGRA2RGBA)
