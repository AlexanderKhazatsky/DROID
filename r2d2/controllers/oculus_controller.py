from r2d2.misc.transformations import quat_to_euler, euler_to_quat, quat_diff, rmat_to_quat, pose_diff, add_angles
...
class VRPolicy:
    ...
    def _calculate_action(self, state_dict, include_info=False):
        ...
        # Return #
        if include_info: return action, info_dict
        else: return action
