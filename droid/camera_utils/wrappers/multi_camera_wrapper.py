...
from droid.misc.parameters import camera_type
...
class MultiCameraWrapper:
    def __init__(self, camera_kwargs={}):
        ...
        assert camera_type in accepted_camera_types, f"Invalid camera_type specified in droid.misc.parameters! Must be one of the following: {accepted_camera_types}"
