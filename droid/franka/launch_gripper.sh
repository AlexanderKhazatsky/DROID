...
launch_gripper.py gripper=franka_hand gripper.executable_cfg.robot_ip=172.16.0.22 # NOTE: Change the robot_ip to match the value in droid.misc.parameters!
