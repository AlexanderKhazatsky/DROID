...
class FrankaRobot:
    def launch_controller(self):
        ...
        assert gripper_type in accepted_gripper_types, f"Invalid gripper_type specified in droid.misc.parameters! Must be one of the following: {accepted_gripper_types}"
